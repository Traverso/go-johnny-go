...
Animax.prototype.easingForKeyFrame = function(target_idx,cue_idx){
  var k = this.currentSegment.keyFrames[target_idx][cue_idx];
  if(!k.easing) return 'linear';
  return k.easing;
};

Animax.prototype.saveEasingForKeyFrame = function(target_idx,cue_idx,easing){
  this.currentSegment.keyFrames[target_idx][cue_idx].easing = easing;
  this.save();
}
